...
describe Puppet::Type.type(:netapp_qtree) do
  ...
  describe "when validating values" do
    describe "for name" do
      ...
      it "should support a nested directory" do
        pending
        described_class.new(:name => 'dir1/dir2', :ensure => :present)[:name].should == 'dir1/dir2'
        described_class.new(:name => 'dir1/dir2/dir3', :ensure => :present)[:name].should == 'dir1/dir2/dir3'
      end
